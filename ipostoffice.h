//
// Created by Sztajer on 2018-12-29.
//
...
public:
     ...
     *
     * If persisted data is available (client has been saved to file previously), it loads
     * it and returns instance filled with data from that file. Otherwise, it creates a new empty instance.
     * Client instances MUST be persisted after they are no longer used.
     */
